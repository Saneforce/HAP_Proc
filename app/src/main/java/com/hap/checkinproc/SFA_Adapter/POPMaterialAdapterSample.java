...
public class POPMaterialAdapterSample extends RecyclerView.Adapter<POPMaterialAdapterSample.MyViewHolder> {
    Context context;
    ...
    public POPMaterialAdapterSample(Context context, List<QPS_Modal> mData) {
    ...
    @NonNull
    @Override
    public POPMaterialAdapterSample.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(POPMaterialAdapterSample.MyViewHolder holder, int position) {
        try {
