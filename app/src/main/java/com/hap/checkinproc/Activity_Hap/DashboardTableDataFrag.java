...
public class DashboardTableDataFrag extends Fragment {
    String mTabName = "";
    View view;
    Context mContext;
    ...
    public DashboardTableDataFrag(Context context, String TabName) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_tabledata_info, container, false);
