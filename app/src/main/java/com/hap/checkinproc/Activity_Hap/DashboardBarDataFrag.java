...
public class DashboardBarDataFrag extends Fragment {
    String mTabName = "";
    ...
    public DashboardBarDataFrag(String TabName) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tabledata_info, container, false);
        recyclerView = view.findViewById(R.id.recyclerView);

        mProductList.clear();


//        mProductList.add(new Product_Details_Modal("Butter", "Hatsun", 1, "1",
//                "1", "5", "i", 7.99, 1.8,
//                50.0, 10, 25, 150.0));
//
