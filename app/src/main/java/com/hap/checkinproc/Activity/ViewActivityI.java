...
public class ViewActivityI extends AppCompatActivity/* implements/* AdapterForSelectionList.OnSelectItemClick */ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(ViewActivityI.this, ViewActivityI.class);
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validationOfField()) {
                    ...
                    Toast.makeText(ViewActivityI.this, "Please fill the mandatory fields", Toast.LENGTH_SHORT).show();
            }
        });
...
//                    timePicker(pos, value);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            if (requestCode == 2 && resultCode == RESULT_OK
                ...
                Toast.makeText(ViewActivityI.this, "You picked " +
                ...
                for (pickedImageCount = 0; pickedImageCount < mClipData.getItemCount();
                    ...
                    String fullPath = filepath.getPath(ViewActivityI.this, mClipData.getItemAt(pickedImageCount).getUri());
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    ImageFilePath filepath = new ImageFilePath();
                    String fullPath = filepath.getPath(ViewActivityI.this, uri);
                    Log.v("file_path_are", fullPath + "print");
                    String PathHolder = data.getData().getPath();
                    filePathing = filePathing + fullPath + ",";

                    if (fullPath == null)
                        Toast.makeText(ViewActivityI.this, "This file format not supported", Toast.LENGTH_LONG).show();
                    else {
                        mm.setValue(filePathing);
                        adp_view.notifyDataSetChanged();
                    }
    ...
    public void captureFile() {
        ...
        outputFileUri = FileProvider.getUriForFile(ViewActivityI.this, getApplicationContext().getPackageName() + ".provider", new File(getExternalCacheDir().getPath(), "pickImageResult" + System.currentTimeMillis() + ".jpeg"));
    ...
    public void popupSpinner(int type, final ArrayList<SelectionModel> array_selection, final int pos, String creationId) {
        try {
            ...
            Dialog dialog = new Dialog(ViewActivityI.this, R.style.AlertDialogCustom);
            ...
            AdapterForSelectionList adapt = new AdapterForSelectionList(ViewActivityI.this, array_selection, type, new AdapterOnClick() {
                @Override
    ...
    public void datePick(final int pos, final int value) {
        ...
        fromDatePickerDialog = new DatePickerDialog(ViewActivityI.this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    if (value == 8) {
                        if (TextUtils.isEmpty(mm.getTvalue()))
                            ...
                            if (dateDifference(val, mm.getTvalue()) < 0)
                                Toast.makeText(ViewActivityI.this, "From date should be lesser", Toast.LENGTH_SHORT).show();
                            else
                                mm.setValue(dayOfMonth + "-" + mnth + "-" + year);
                        }
                    } else {
                        if (TextUtils.isEmpty(mm.getValue()))
                            Toast.makeText(ViewActivityI.this, "Fill from date", Toast.LENGTH_SHORT).show();
                        else {
                            String val = dayOfMonth + "-" + mnth + "-" + year;
                            if (dateDifference(mm.getValue(), val) < 0)
                                Toast.makeText(ViewActivityI.this, "To date should be greater", Toast.LENGTH_SHORT).show();
                            else
    ...
    public void timePicker(final int pos, final int value) {
        ...
        timePickerDialog = new TimePickerDialog(ViewActivityI.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
            public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                ...
                if (mm.getViewid().equalsIgnoreCase("12")) {
                    if (value == 12) {
                        if (TextUtils.isEmpty(mm.getTvalue()))
                            ...
                            if (thr == selectedHour) {
                                if (selectedMinute < tmin) {
                                    ...
                                    Toast.makeText(ViewActivityI.this, "From time should be lesser", Toast.LENGTH_SHORT).show();
                        ...
                        if (TextUtils.isEmpty(mm.getValue()))
                            Toast.makeText(ViewActivityI.this, "Fill the from  time", Toast.LENGTH_SHORT).show();
                        else {
                            ...
                            if (fhr == selectedHour) {
                                if (selectedMinute > fmin) {
                                    ...
                                    Toast.makeText(ViewActivityI.this, "To time should be greater", Toast.LENGTH_SHORT).show();
    ...
    void createDynamicView(String data) {
        try {
            ...
            if (jsonArray.length() == 0) {
                Toast.makeText(ViewActivityI.this, "No controls available for this form ", Toast.LENGTH_SHORT).show();
                ...
                if (jsonjk.getString("Control_id").equalsIgnoreCase("19")) {
                    ...
                    adp_view = new AdapterForDynamicView(ViewActivityI.this, array_view);
                    ...
                    if (response.isSuccessful()) {
                        ...
                        try {
                            ...
                            if (jj.getString("success").equalsIgnoreCase("true")) {
                                ...
                                Intent i = new Intent(ViewActivityI.this, SFA_Activity.class);
                                startActivity(i);
                            }
    ...
    public void popupCapture() {
        final Dialog dialog = new Dialog(ViewActivityI.this, R.style.AlertDialogCustom);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    if (response.isSuccessful()) {
                        ...
                        try {
                            ...
                            adpt = new FilterDemoAdapter(ViewActivityI.this, jarray, gettingfield, 0, json.getString("Target_Form"));
