...
public class Leave_Status_Adapter extends RecyclerView.Adapter<Leave_Status_Adapter.MyViewHolder> {
    ...
    public void onBindViewHolder(Leave_Status_Adapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if ((!AMod.equalsIgnoreCase("1")) && Leave_Status_ModelsList.get(position).getShowFlag().equalsIgnoreCase("1")  && Leave_Status_ModelsList.get(position).getLeaveActiveFlag()<5 && Leave_Status_ModelsList.get(position).getLeaveActiveFlag() != 3&& Leave_Status_ModelsList.get(position).getLeaveActiveFlag() != 9) {
