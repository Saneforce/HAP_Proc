...
public class WeekOff_Status_Adapter extends RecyclerView.Adapter<WeekOff_Status_Adapter.MyViewHolder> {
    ...
    public WeekOff_Status_Adapter(List<WeekOff_Status_Model> Onduty_Status_ModelsList, int rowLayout, Context context) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView onWorkType, onWorkDate, onWorkDay, onWorkSubmitDate;
