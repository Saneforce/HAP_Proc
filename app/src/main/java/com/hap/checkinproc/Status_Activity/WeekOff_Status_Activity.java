...
public class WeekOff_Status_Activity extends AppCompatActivity {
    ...
    private void getWeekOffStatus() {
        ...
        Call<Object> mCall = apiInterface.GetTPObject1("1", Shared_Common_Pref.Div_Code, Shared_Common_Pref.Sf_Code, Shared_Common_Pref.Sf_Code, Shared_Common_Pref.StateCode, "Get/WkoffStatus", routemaster);
