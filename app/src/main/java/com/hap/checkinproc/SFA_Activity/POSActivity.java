...
public class POSActivity extends AppCompatActivity implements View.OnClickListener, UpdateResponseUI {
    ...
    TextView Out_Let_Name, Category_Nametext,
            tvOtherBrand, tvQPS, tvPOP, tvCoolerInfo, tvDeliveryDate, tvRetailorPhone, retaileAddress, tvScanBarcode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            sharedCommonPref = new Shared_Common_Pref(POSActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btnCallMob:
                common_class.showCalDialog(POSActivity.this, "Do you want to Call this Outlet?",
                ...
                public void PositiveMethod(DialogInterface dialog, int id) {
                    ...
                    try {
                        ...
                        for (int z = 0; z < Getorder_Array_List.size(); z++) {
                            ...
                            ProdItem.put("MRP", String.format("%.2f", Getorder_Array_List.get(z).getMRP()));
    ...
    public class Prodct_Adapter extends RecyclerView.Adapter<Prodct_Adapter.MyViewHolder> {
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            try {
                ...
                holder.Rate.setText("₹" + formatter.format(Double.parseDouble(Product_Details_Modal.getMRP())));
                ...
                if (CategoryType >= 0) {
                    ...
                    holder.regularAmt.setText("₹" + new DecimalFormat("##0.00").format(Product_Details_Modal.getRegularQty() * Double.parseDouble(Product_Details_Modalitem.get(holder.getAdapterPosition()).getMRP())));

                    holder.QtyAmt.setText("₹" + formatter.format(Double.parseDouble(Product_Details_Modal.getMRP()) * Product_Details_Modal.getQty()));
