...
public class Van_Order_Category_Select extends AppCompatActivity implements View.OnClickListener, UpdateResponseUI, Master_Interface {
    ...
    String TAG = "Van_Order_Category_Select";
    DatabaseHandler db;
    ...
    public static Van_Order_Category_Select order_category_select;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            setContentView(R.layout.activity_van_order_category_select);
            order_category_select = this;
            db = new DatabaseHandler(this);
            sharedCommonPref = new Shared_Common_Pref(Van_Order_Category_Select.this);
...
//            }
    ...
    private void GetJsonData(String jsonResponse, String type, String filter) {
        ...
        try {
            ...
            if (type.equals("1")) {
                ...
                Van_Order_Category_Select.CategoryAdapter customAdapteravail = new Van_Order_Category_Select.CategoryAdapter(getApplicationContext(),
                        Category_Modal);
        ...
        for (int pm = 0; pm < Product_Modal.size(); pm++) {
            if (Product_Modal.get(pm).getQty() > 0 || Product_Modal.get(pm).getRegularQty() > 0) {
                ...
                try {
                   ...
                   // throw new RuntimeException(e);
                    Log.e("orderShowlist:",e.getMessage());
                }
            }
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnCallMob:
                common_class.showCalDialog(Van_Order_Category_Select.this, "Do you want to Call this Outlet?",
                        tvRetailorPhone.getText().toString().replaceAll(",", ""));

                break;
            case R.id.tvDeliveryDate:
                Calendar newCalendar = Calendar.getInstance();
                fromDatePickerDialog = new DatePickerDialog(Van_Order_Category_Select.this, new DatePickerDialog.OnDateSetListener() {
            ...
            case R.id.btnRepeat:
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        common_class.getDataFromApi(Constants.REPEAT_VAN_ORDER, Van_Order_Category_Select.this, false);
                    }
                }, 500);
                break;
    ...
    private void SaveOrder() {
        ...
        AlertDialogBox.showDialog(Van_Order_Category_Select.this, "HAP SFA", "Are You Sure Want to Submit?", "OK", "Cancel", false, new AlertBox() {
            @Override
            public void PositiveMethod(DialogInterface dialog, int id) {
                ...
                try {
                    ...
                    OutletItem.put("ordertype", "VanSales");
                ...
                Call<JsonObject> responseBodyCall = apiInterface.saveVanCalls(Shared_Common_Pref.Div_Code, Shared_Common_Pref.Sf_Code, data.toString());
                    ...
                    public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                        ...
                        if (response.isSuccessful()) {
                            try {
                                ...
                                common_class.showMsg(Van_Order_Category_Select.this, jsonObjects.getString("Msg"));
...
//        }
    ...
    private void FilterProduct(List<Product_Details_Modal> orderList) {
        try {
            ...
            mProdct_Adapter = new Prodct_Adapter(orderList, R.layout.van_product_pay_recyclerview_edit, getApplicationContext(), -1);
            recyclerView.setAdapter(mProdct_Adapter);
            updateToTALITEMUI(1);
            showFreeQtyList();
        }catch (Exception e){
            Log.e("dsfg",e.getMessage());
        }
    }
    ...
    void showFreeQtyList() {
        try {
            ...
            if (freeQty_Array_List != null && freeQty_Array_List.size() > 0) {
                ...
                Van_Order_Category_Select.Free_Adapter mFreeAdapter = new Van_Order_Category_Select.Free_Adapter(freeQtyNew, R.layout.product_free_recyclerview, getApplicationContext());
    ...
    public void showOrderItemList(int categoryPos, String filterString) {
        ...
        mProdct_Adapter = new Van_Order_Category_Select.Prodct_Adapter(Product_ModalSetAdapter, R.layout.van_product_order_recyclerview, getApplicationContext(), categoryPos);
        recyclerView.setAdapter(mProdct_Adapter);
            ...
            switch (key) {
                case Constants.REPEAT_VAN_ORDER:
                    if (Common_Class.isNullOrEmpty(apiDataResponse) || apiDataResponse.equals("[]")) {
                        ResetSubmitBtn(0);
                        common_class.showMsg(Van_Order_Category_Select.this, "No Records Found.");
                    } else
...
//                            double sellAmt=dMRPAmt-dMrgn;
    ...
    public void OnclickMasterType(List<Common_Model> myDataset, int position, int type) {
        ...
        switch (type) {
            case 1:
                ...
                mProdct_Adapter.notify(Product_ModalSetAdapter, R.layout.van_product_order_recyclerview, getApplicationContext(), 1);
    ...
    public class CategoryAdapter extends RecyclerView.Adapter<Van_Order_Category_Select.CategoryAdapter.MyViewHolder> {
        Context context;
        Van_Order_Category_Select.CategoryAdapter.MyViewHolder pholder;
        ...
        @Override
        public Van_Order_Category_Select.CategoryAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
            View view = layoutInflater.inflate(R.layout.category_order_horizantal_universe_gridview, parent, false);
            return new Van_Order_Category_Select.CategoryAdapter.MyViewHolder(view);
        }
        ...
        @Override
        public void onBindViewHolder(Van_Order_Category_Select.CategoryAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
            try {
    ...
    public class Prodct_Adapter extends RecyclerView.Adapter<Van_Order_Category_Select.Prodct_Adapter.MyViewHolder> {
        Context context;
        int CategoryType;
        ...
        @Override
        public Van_Order_Category_Select.Prodct_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(rowLayout, parent, false);
            return new Van_Order_Category_Select.Prodct_Adapter.MyViewHolder(view);
        }
        ...
        @Override
        public void onBindViewHolder(Van_Order_Category_Select.Prodct_Adapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
            try {
                    ...
                    holder.rlUOM.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (Product_Details_Modal.getUOMList() != null && Product_Details_Modal.getUOMList().size() > 0) {
                                ...
                                common_class.showCommonDialog(uomList, 1, Van_Order_Category_Select.this);
                            } else {
                                common_class.showMsg(Van_Order_Category_Select.this, "No Records Found.");
                            }
                        }
...
//                            }
                ...
                if (CategoryType == -1) {
                    holder.ivDel.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            AlertDialogBox.showDialog(Van_Order_Category_Select.this, "HAP SFA",
        ...
        private void showDialog(Product_Details_Modal product_details_modal) {
            try {
                ...
                LayoutInflater inflater = LayoutInflater.from(Van_Order_Category_Select.this);

                final View view = inflater.inflate(R.layout.edittext_price_dialog, null);
                AlertDialog alertDialog = new AlertDialog.Builder(Van_Order_Category_Select.this).create();
                ...
                btnSave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (Common_Class.isNullOrEmpty(etComments.getText().toString())) {
                            common_class.showMsg(Van_Order_Category_Select.this, "Empty value is not allowed");
                        } else if (Double.valueOf(etComments.getText().toString()) > Double.valueOf(product_details_modal.getMRP())) {
                            common_class.showMsg(Van_Order_Category_Select.this, "Enter Rate is greater than "+MRPCap);
...
//                    tvUomQty = view.findViewById(R.id.tvUomQty);
    ...
    public class Free_Adapter extends RecyclerView.Adapter<Van_Order_Category_Select.Free_Adapter.MyViewHolder> {
        Context context;
        ...
        @Override
        public Van_Order_Category_Select.Free_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(rowLayout, parent, false);
            return new Van_Order_Category_Select.Free_Adapter.MyViewHolder(view);
        }
        ...
        @Override
        public void onBindViewHolder(Van_Order_Category_Select.Free_Adapter.MyViewHolder holder, int position) {
            try {
    ...
    public void loadUomFirstData(List<Product_Details_Modal> Product_Details_Modalitem, Van_Order_Category_Select.Prodct_Adapter.MyViewHolder holder, int CategoryType) {
        try {
            Product_Details_Modal Product_Details_Modal=Product_Details_Modalitem.get(holder.getBindingAdapterPosition());
