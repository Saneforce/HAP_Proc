        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            try {
                ...
                if (CategoryType >= 0) {
                    ...
                    holder.regularAmt.setText(CurrencySymbol + " " + new DecimalFormat("##0.00").format(Product_Details_Modal.getRegularQty() * Product_Details_Modalitem.get(holder.getAdapterPosition()).getRate()*Product_Details_Modalitem.get(holder.getAdapterPosition()).getCnvQty()));
                ...
                btnSave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (Common_Class.isNullOrEmpty(etComments.getText().toString())) {
                            ...
                            common_class.showMsg(IndentActivity.this, "Enter Rate is greater than MRP");
